<%@page import="com.twitter.beans.Follower"%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
<%@ page import="java.sql.ResultSet" %>
<%@page import="java.util.ArrayList"%>
<%@page import="com.twitter.beans.User"%>
<%
        ...
        <%} %>
                   ...
                   <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="tweet.jsp"><i
                                    class="glyphicon glyphicon-star"></i><span> Send Post</span></a></li>
                        <li><a class="ajax-link" href="TweetViewController"><i
                                    class="glyphicon glyphicon-star"></i><span> View Post</span></a></li>
