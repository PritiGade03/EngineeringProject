...
<div class="ch-container">
   ...
   Object op=session.getAttribute("precision");
   double precision=Double.parseDouble(op.toString());
	Object orecall = session.getAttribute("recall");
	double recall=Double.parseDouble(orecall.toString());
	Object ofmeasure=session.getAttribute("fmeasure");
	double fmeasure=Double.parseDouble(ofmeasure.toString());
	Object oaccuracy=session.getAttribute("accuracy");
	double accuracy=Double.parseDouble(oaccuracy.toString());
	Object otpr=session.getAttribute("tpr");
	Object ofpr=session.getAttribute("fpr");
