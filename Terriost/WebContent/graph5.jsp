...
<div class="ch-container">
   ...
   Object op=session.getAttribute("precision2");
   double precision=Double.parseDouble(op.toString());
	Object orecall = session.getAttribute("recall2");
	double recall=Double.parseDouble(orecall.toString());
	Object ofmeasure=session.getAttribute("fmeasure2");
	double fmeasure=Double.parseDouble(ofmeasure.toString());
	Object oaccuracy=session.getAttribute("accuracy2");
	double accuracy=Double.parseDouble(oaccuracy.toString());
	Object otpr=session.getAttribute("tpr2");
	Object ofpr=session.getAttribute("fpr2");
  double tpr=Double.parseDouble(otpr.toString());
  double fpr=Double.parseDouble(ofpr.toString());
   	
   %>
   <div class="row">
   <div class="col-md-9">
   	<div id="container" style="height: 400px"></div><br>
   	<div><a class="btn btn-primary" href="graph6.jsp">Comparison Graph</a></div>
   	</div>
				...
				.highcharts(
						{
							...
							title : {
								text : 'SVM Performance'
							},
							subtitle : {
								text : 'Performance Evaluation'
							},
							xAxis : {
								categories : [ 'Tweets Classification',
