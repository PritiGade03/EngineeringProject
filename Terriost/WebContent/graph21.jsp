...
<div class="ch-container">
	...
	<br>
		...
		<%
   Object posScore=session.getAttribute("spam");
	Object negScore=session.getAttribute("nonspam");
   double spam=Double.parseDouble(posScore.toString());
   double nonspam=Double.parseDouble(negScore.toString());
   ...
   <div class="col-md-9">
   	...
   	<div><a href="graph31.jsp">Performance</a></div>
   	</div>
