<%@page import="com.twitter.beans.RealTweetStream"%>
...
<div class="row">        
    ...
    <div class="row">
        <div class="well col-md-9  login-box">
            ...
            <a href="graph2.jsp" class="btn btn-primary">Generate Graph</a>
    		...
    		<tr>
        		...
        		<th><%=tweetStreamList.get(i).getUserMention() %></th>
        		<th><%=tweetStreamList.get(i).getUrlCount() %></th>
        		<th><%=tweetStreamList.get(i).getCharCount() %></th>
        		<th><%=tweetStreamList.get(i).getDigitCount() %></th>
        		<th><%=tweetStreamList.get(i).getResult() %></th>
        		<th><%=tweetStreamList.get(i).getResultProb() %></th>
