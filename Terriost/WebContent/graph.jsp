   ...
   double negScore=0;
   	...
   	if(twitList!=null && twitList.size()>0){
   		for(int i=0;i<twitList.size();i++){
   			if(twitList.get(i).getBayesResult().equals("positive")){
   				posScore = posScore + twitList.get(i).getBayesProbability();	
   			}else{
   				negScore = negScore + twitList.get(i).getBayesProbability();
   			}
