...
public class CreateArff2 {
	public static String createArffFile(ArrayList<TweetStream> twitStreamList){
		...
		String file="E:\\workspace 2019\\Priya Pawar DYP Lohgaon\\TwitterSentimentAnalysis\\WebContent\\upload\\train_off3.arff";
...
*/	        data.add(new Instance(1.0, vals));
	...
	public static String createArffFile1(ArrayList<RealTweetStream> twitStreamList){
		ArffSaver saver = new ArffSaver();
		String file="E:\\workspace 2019\\Priya Pawar DYP Lohgaon\\TwitterSentimentAnalysis\\WebContent\\upload\\train_real3.arff";
		File f=new File(file);
		FastVector      atts;
	    FastVector      attsRel;
	    FastVector      attVals;
